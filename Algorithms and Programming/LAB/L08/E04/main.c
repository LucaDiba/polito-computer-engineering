...
enum{
    c_first, c_stampa_elenco, c_stampa_percategoria,
    c_stampa_esercizi, c_cerca_stampa_esercizio,
    c_aggiornamonteore, c_search_bycodice, c_search_bycognome,
    c_atleta_add, c_atleta_del, c_exit
};
